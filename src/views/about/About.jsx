      ...
      <div className="py-6 sm:py-8 lg:py-12">
        <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          <article className="mb-10 md:mb-16">
            ...
            <br />
            <p className="max-w-screen-md text-gray-100 md:text-lg text-center mx-auto">
              udns is a free service that allows you to register domains for
              free. It works today. No reinventing the wheel, but rather taking
              the good parts of what’s there and making the simplest tool
              possible.
            </p>
            <br />
            <p className="max-w-screen-md text-gray-100 md:text-lg text-center mx-auto">
