      ...
      <div class="bg-transparent py-6 sm:py-8 lg:py-12">
        <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
          ...
          <div class="mb-10 md:mb-16">
            <h2 class="text-gray-700 text-2xl lg:text-3xl font-bold text-center drop-shadow:lg mb-4 md:mb-6">
              Frequently asked questions
            </h2>

            <p class="max-w-screen-md text-gray-900 md:text-lg text-center mx-auto">
